...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Gamecoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.gamecoinproject.org", "seed1.netseed.net", ""};
static const string testnet_seeds[] = {"testnet-seed1.gamecoinproject.org",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9776), true);
  }
  do {
